...
beautiful.init("/home/Josh/.config/awesome/themes/nord/theme.lua")
...
globalkeys = gears.table.join(
    ...
    -- Rofi Menubar
    awful.key({ modkey, "Shift"   }, "Return", function() awful.util.spawn_with_shell("bash /home/Josh/.config/rofi/launchers/type-1/launcher.sh") end,
    ...
    awful.key({ modkey, "Shift"   }, "Escape", function() awful.util.spawn_with_shell("bash /home/Josh/.config/rofi/powermenu/type-1/powermenu.sh") end,
...
-- Set the wallpaper
gears.wallpaper.maximized("/home/Josh/Downloads/sky4.jpg", s)
