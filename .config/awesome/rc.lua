			...
			{
				{
					layout_tile.name,
					function()
						awful.layout.set(layout_tile.layout)
					end,
				},
				{
					layout_floating.name,
					function()
						awful.layout.set(layout_floating.layout)
					end,
				},
				{
					layout_spiral.name,
					function()
						awful.layout.set(layout_spiral.layout)
					end,
				},
			},
		},
...
globalkeys = gears.table.join(
	awful.key({ modkey }, "o", hotkeys_popup.show_help, { description = "show help", group = "Awesome" }),
	awful.key({ modkey }, "h", awful.tag.viewprev, { description = "view previous", group = "Awesome" }),
	awful.key({ modkey }, "l", awful.tag.viewnext, { description = "view next", group = "Awesome" }),
	...
	awful.key({ modkey }, ",", function()
		mymainmenu:show()
	end, { description = "show awesome menu", group = "Awesome" }),
	...
	awful.key({ modkey }, "f", function()
		awful.spawn("alacritty --class AlacrittyFloating")
	end, { description = "open a terminal w/ fetch", group = "Awesome" }),
	awful.key({ modkey }, "v", function()
		awful.spawn.with_shell("alacritty -e nvim")
	end, { description = "open nvim", group = "Awesome" }),
	awful.key({ modkey }, "b", function()
		awful.spawn(browser)
	end, { description = "open a browser", group = "Awesome" }),
	awful.key({ modkey, "Control" }, "r", awesome.restart, { description = "reload awesome", group = "Awesome" }),
	awful.key({ modkey, "Shift" }, "q", awesome.quit, { description = "quit awesome", group = "Awesome" }),
	awful.key({ modkey }, "space", function()
		awful.spawn.with_shell("bash ~/.local/bin/keyboard-layout.sh")
	end, { description = "toggle keyboard layout", group = "Awesome" }),

	-- F(unction) Keys
	awful.key({}, "F4", function()
		awful.spawn.with_shell("bash ~/.local/bin/toggle-monitor.sh")
	end, { description = "toggle monitor", group = "Function" }),
	...
	end, { description = "decrease volume", group = "Function" }),
	awful.key({}, "F8", function()
		awful.spawn.with_shell("pactl set-sink-volume @DEFAULT_SINK@ +10%")
	end, { description = "increase volume", group = "Function" }),

	-- Rofi Menubar
	awful.key({ modkey, "Shift" }, "Return", function()
		awful.util.spawn_with_shell("bash ~/.config/rofi/launchers/type-1/launcher.sh")
	end, { description = "show rofi drun", group = "Menu" }),
	awful.key({ modkey, "Shift" }, "w", function()
		awful.util.spawn_with_shell("bash ~/.config/rofi/applets/bin/rofi-wifi-menu.sh")
	end, { description = "show rofi wifi", group = "Menu" }),
	awful.key({ modkey, "Shift" }, "v", function()
		awful.util.spawn_with_shell("rofi -modi emoji -show emoji")
	end, { description = "show rofi emoji", group = "Menu" }),
	awful.key({ modkey, "Shift" }, "Escape", function()
		awful.util.spawn_with_shell("bash ~/.config/rofi/powermenu/type-2/powermenu.sh")
	end, { description = "show rofi power", group = "Menu" }),
	awful.key({ modkey, "Shift" }, "s", function()
		awful.util.spawn_with_shell("flameshot gui")
	end, { description = "screenshot with flameshot", group = "Menu" })
)
